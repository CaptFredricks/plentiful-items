...
public final class ModShulkerBoxContainer extends Container {
    private final IInventory inventory;

    public ModShulkerBoxContainer(int id, PlayerInventory playerInventory) {
    ...
    public ModShulkerBoxContainer(int id, PlayerInventory playerInventory, IInventory inventory) {
        ...
        for(int k = 0; k < 3; ++k) {
            for(int l = 0; l < 9; ++l) {
                this.addSlot(new ModShulkerBoxSlot(inventory, l + k * 9, 8 + l * 18, 18 + k * 18));
            }
        }
