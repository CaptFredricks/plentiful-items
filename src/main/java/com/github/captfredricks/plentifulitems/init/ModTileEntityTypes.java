...
public final class ModTileEntityTypes {
    ...
    // Register crates
    public static final RegistryObject<TileEntityType<CrateTileEntity>> CRATE = TILE_ENTITY_TYPES.register("crate", () -> TileEntityType.Builder.of(CrateTileEntity::new, ModBlocks.CRATE.get()).build(null));
    public static final RegistryObject<TileEntityType<ReinforcedCrateTileEntity>> REINFORCED_CRATE = TILE_ENTITY_TYPES.register("reinforced_crate", () -> TileEntityType.Builder.of(ReinforcedCrateTileEntity::new, ModBlocks.REINFORCED_CRATE.get()).build(null));
}
