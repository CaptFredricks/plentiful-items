...
import com.github.captfredricks.plentifulitems.init.ModBlocksVanilla;
...
public final class ModShulkerBoxBlock extends ContainerBlock {
    private static final Logger LOGGER = LogManager.getLogger(Main.MODID + "/ShulkerBox");
    ...
    public ModShulkerBoxBlock(@Nullable DyeColor color, AbstractBlock.Properties properties) {
        super(properties);
        this.color = color;
    ...
    public TileEntity createNewTileEntity(IBlockReader worldIn) {
        return new ModShulkerBoxTileEntity(this.color);
    }
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        TileEntity tileentity = worldIn.getTileEntity(pos);
        return tileentity instanceof ModShulkerBoxTileEntity ? VoxelShapes.create(((ModShulkerBoxTileEntity)tileentity).getBoundingBox(state)) : VoxelShapes.fullCube();
    }
    ...
    public static DyeColor getColorFromBlock(Block blockIn) {
        return blockIn instanceof ModShulkerBoxBlock ? ((ModShulkerBoxBlock)blockIn).getColor() : null;
    }

    @Nonnull
    public static Block getBlockByColor(@Nullable DyeColor colorIn) {
        if(colorIn == null) {
            return ModBlocksVanilla.SHULKER_BOX.get();
        } else {
            switch(colorIn) {
                case WHITE:
                    return ModBlocksVanilla.WHITE_SHULKER_BOX.get();
                case ORANGE:
